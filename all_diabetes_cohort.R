...
#	1E Irish														0. White
#	1F Welsh														0. White
#	1G Northen Irish												0. White
#	1H British														0. White
#	1J Irish														0. White
#	1K Gypsy/Traveller												0. White
#	1L Polish														0. White
#	1Z Any other white ethnic group									0. White
#	2A Any mixed or multiple ethnic groups							4. Mixed
#	3F Pakistani, Pakistani Scottish or Pakistani British			1. South Asian
#	3G Indian, Indian Scottish or Pakistani Bristish				1. South Asian
#	3H Bangladeshi, Bangladeshi Scottish or Bangladeshi British		1. South Asian
#	3J Chinese, Chinese Scottish or Chinese British					3. Other
#	3Z Other - Asian, Asian Scottish or Asian British				1. South Asian
#	4D African, African Scottish or Asian British					2. Black
#	4E Caribbean, Caribbean Scottish or Caribbean British			2. Black
#	4F Black, Black Scottish or Black British						2. Black
#	4Z Other - African, Caribbean or Black							2. Black
#	5B Arab															3. Other
#	5Z Other - Other ethnic group									3. Other
#	98 Refused														5. Not stated/Unknown
#	99 Not Known													5. Not stated/Unknown
...
diabetes_cohort <- diabetes_cohort %>%
		...
		select(serialno, gender, dob, death_date, diabetes_type, ethnicity_5cat, simd_decile, imd_decile, dm_diag_date_all, dm_diag_age_all)
