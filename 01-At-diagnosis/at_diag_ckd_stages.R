...
# Identify those with diabetes at diagnosis, identify ckd stage
...
save(ckd_stages, file = "/home/pcardoso/workspace/SDRN-Cohort-scripts/Interim_Datasets/at_diag_ckd_stages.RData")
