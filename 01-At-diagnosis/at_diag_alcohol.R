...
# Identify those with diabetes at diagnosis, alcohol
...
pre_index_date_alcohol_codes <- index_dates %>%
		inner_join(clean_alcohol_medcodes, by = "serialno") %>%
...
save(alcohol, file = "/home/pcardoso/workspace/SDRN-Cohort-scripts/Interim_Datasets/at_diag_alcohol.RData")
